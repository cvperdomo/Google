...
<form id="f2" action="eliminarContacto" method="POST">
  <div class="clearfix" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
    ...
    <div class="clearfix colelem" id="ppu274-4"><!-- group -->
     ...
     <a class="nonblock nontext MuseLinkActive museBGSize grpelem" id="u277" href="contactos.jsp"><!-- simple frame --></a>
...
ResultSet rs = conn.createStatement().executeQuery(
    "select c.id_contacto as contacto,c.nombre_contacto as contacto, o.nombre_organizacion as organizacion, c.PUESTO as contacto, cc.nombre_contacto as contacto from organizacion o, contacto c left join contacto cc on cc.ID_CONTACTO=c.ASIGNADO_A where o.ID_ORGANIZACION  = c.ID_ORGANIZACION;");
%>		
    <div class="colelem" id="pu404"><!-- inclusion -->
     ...
     <div class="clearfix" id="pu405-4"><!-- group -->
      ...
      <a href="/contacto.jsp"> <img class="svg grpelem" id="u535" src="images/mas.svg" width="24" height="23"  alt="Agregar Nueva Organizacion" data-mu-svgfallback="images/mas_poster_.png"/><!-- svg --></a>
